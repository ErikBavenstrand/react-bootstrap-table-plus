...
var editBtnDefaultClass = 'react-bs-table-edit-btn';
    ...
    _createClass(EditButton, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                btnstate = _props.btnstate.value,
            ...
            return _react2.default.createElement(
                ...
                _extends({ type: 'button',
                    className: 'btn ' + btnContextual + ' ' + editBtnDefaultClass + ' ' + btnstate + ' ' + className,
                    onClick: onClick
                },  rest),
                content
            );
...
EditButton.propTypes = {
    ...
    btnstate: _propTypes2.default.object,
    className: _propTypes2.default.string,
    onClick: _propTypes2.default.func,
    btnGlyphicon: _propTypes2.default.string
};
EditButton.defaultProps = {
    btnText: _Const2.default.EDIT_BIN_TEXT,
    ...
    className: '',
    onClick: undefined,
    btnGlyphicon: 'glyphicon-edit fa-edit',
};
...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(editBtnDefaultClass, 'editBtnDefaultClass', '/Users/allen/Node/react-bootstrap-table-new/react-bootstrap-table/src/toolbar/EditButton.js');

    __REACT_HOT_LOADER__.register(EditButton, 'EditButton', '/Users/allen/Node/react-bootstrap-table-new/react-bootstrap-table/src/toolbar/EditButton.js');

    __REACT_HOT_LOADER__.register(_default, 'default', '/Users/allen/Node/react-bootstrap-table-new/react-bootstrap-table/src/toolbar/EditButton.js');
}();
