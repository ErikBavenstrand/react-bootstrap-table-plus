...
var EditModalHeader = function (_Component) {
  _inherits(EditModalHeader, _Component);

  function EditModalHeader() {
    var _ref;

    var _temp, _this, _ret;

    _classCallCheck(this, EditModalHeader);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = EditModalHeader.__proto__ || Object.getPrototypeOf(EditModalHeader)).call.apply(_ref, [this].concat(args))), _this), _this.handleCloseBtnClick = function () {
      var _this2;
...
var _temp2 = function () {
  ...
  __REACT_HOT_LOADER__.register(EditModalHeader, 'EditModalHeader', '/Users/allen/Node/react-bootstrap-table-new/react-bootstrap-table/src/toolbar/EditModalHeader.js');

  __REACT_HOT_LOADER__.register(_default, 'default', '/Users/allen/Node/react-bootstrap-table-new/react-bootstrap-table/src/toolbar/EditModalHeader.js');
}();
