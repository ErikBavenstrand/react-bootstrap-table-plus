...
var _EditModalHeader = require('./EditModalHeader');

var _EditModalHeader2 = _interopRequireDefault(_EditModalHeader);

var _EditModalFooter = require('./EditModalFooter');

var _EditModalFooter2 = _interopRequireDefault(_EditModalFooter);

var _EditModalBody = require('./EditModalBody');

var _EditModalBody2 = _interopRequireDefault(_EditModalBody);
...
var defaultModalClassName = 'react-bs-table-edit-modal';
...
var EditModal = function (_Component) {
  ...
  function EditModal() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = EditModal.__proto__ || Object.getPrototypeOf(EditModal)).call.apply(_ref, [this].concat(args))), _this), _this.handleSave = function () {
      var _this2;
  ...
  _createClass(EditModal, [{
    ...
    value: function __handleSave__REACT_HOT_LOADER__() {
      if (this.body.getFieldValue) {
        ...
        console.error('Custom EditModalBody should implement getFieldValue function\n        and should return an object presented as the new row that user input.');
      }
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      var bodyAttr = { columns: columns, data: data, validateState: validateState, ignoreEditable: ignoreEditable };

      
      bodyComponent = bodyComponent && bodyComponent(columns, data, validateState, ignoreEditable);
      ...
      if (headerComponent && headerComponent.type.name === _EditModalHeader2.default.name) {
        var eventProps = {};
      ...
      } else if (headerComponent && headerComponent.type.name !== _EditModalHeader2.default.name) {
      ...
      if (footerComponent && footerComponent.type.name === _EditModalFooter2.default.name) {
        var _eventProps = {};
      ...
      } else if (footerComponent && footerComponent.type.name !== _EditModalFooter2.default.name) {
      ...
      return _react2.default.createElement(
        ...
        headerComponent || _react2.default.createElement(_EditModalHeader2.default, {
          version: this.props.version,
          className: 'react-bs-table-edit-modal-header',
          onModalClose: onModalClose }),
        bodyComponent || _react2.default.createElement(_EditModalBody2.default, _extends({ ref: function ref(node) {
            return _this3.body = node;
          } }, bodyAttr)),
        footerComponent || _react2.default.createElement(_EditModalFooter2.default, {
          className: 'react-bs-table-edit-modal-footer',
          onModalClose: onModalClose,
...
var _temp2 = function () {
  ...
  __REACT_HOT_LOADER__.register(defaultModalClassName, 'defaultModalClassName', '/Users/allen/Node/react-bootstrap-table-new/react-bootstrap-table/src/toolbar/EditModal.js');

  __REACT_HOT_LOADER__.register(EditModal, 'EditModal', '/Users/allen/Node/react-bootstrap-table-new/react-bootstrap-table/src/toolbar/EditModal.js');

  __REACT_HOT_LOADER__.register(_default, 'default', '/Users/allen/Node/react-bootstrap-table-new/react-bootstrap-table/src/toolbar/EditModal.js');
}();
