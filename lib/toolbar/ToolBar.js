    ...
    value: function render() {
      ...
      if (this.props.enableEdit) {
        if (this.props.editBtn) {
          editBtn = this.renderCustomBtn(this.props.editBtn, [this.handleModalOpen], _EditButton2.default.name, 'onClick', this.handleModalClose);
        } else {
          editBtn = _react2.default.createElement(_EditButton2.default, { btnText: this.props.inserText,
            onClick: this.handleModalOpen });
        }
      }
