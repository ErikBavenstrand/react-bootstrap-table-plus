...
var ToolBar = function (_Component) {
  ...
  function ToolBar(props) {
    ...
    _this.handleEditSaveBtnClick = function () {
      return _this.__handleEditSaveBtnClick__REACT_HOT_LOADER__.apply(_this, arguments);
    };
    ...
    _this.handleInsertModalClose = function () {
      return _this.__handleInsertModalClose__REACT_HOT_LOADER__.apply(_this, arguments);
    };

    _this.handleInsertModalOpen = function () {
      return _this.__handleInsertModalOpen__REACT_HOT_LOADER__.apply(_this, arguments);
    };

    _this.handleEditModalClose = function () {
      return _this.__handleEditModalClose__REACT_HOT_LOADER__.apply(_this, arguments);
    };

    _this.handleEditModalOpen = function () {
      return _this.__handleEditModalOpen__REACT_HOT_LOADER__.apply(_this, arguments);
    };
    ...
    _this.setEditBtnState = function (state) {
      this.props.editState.value = state;
    }

    _this.setSelectedRowData = function (row) {
      this.props.data.value = row;
    }
  ...
  _createClass(ToolBar, [{
    ...
    key: '__handleInsertModalOpen__REACT_HOT_LOADER__',
    value: function __handleInsertModalOpen__REACT_HOT_LOADER__() {
      return this.__handleInsertModalOpen__REACT_HOT_LOADER__.apply(this, arguments);
    }
  }, {
    key: '__handleInsertModalClose__REACT_HOT_LOADER__',
    value: function __handleInsertModalClose__REACT_HOT_LOADER__() {
      return this.__handleInsertModalClose__REACT_HOT_LOADER__.apply(this, arguments);
    }
  }, {
    key: '__handleEditModalOpen__REACT_HOT_LOADER__',
    value: function __handleEditModalOpen__REACT_HOT_LOADER__() {
      return this.__handleEditModalOpen__REACT_HOT_LOADER__.apply(this, arguments);
    }
  }, {
    key: '__handleEditModalClose__REACT_HOT_LOADER__',
    value: function __handleEditModalClose__REACT_HOT_LOADER__() {
      return this.__handleEditModalClose__REACT_HOT_LOADER__.apply(this, arguments);
    }
  }, {
    ...
    key: '__handleEditSaveBtnClick__REACT_HOT_LOADER__',
    value: function __handleEditSaveBtnClick__REACT_HOT_LOADER__() {
      return this.__handleEditSaveBtnClick__REACT_HOT_LOADER__.apply(this, arguments);
    }
  }, {
    ...
    key: '__handleEditSaveBtnClick__REACT_HOT_LOADER__',
    value: function __handleEditSaveBtnClick__REACT_HOT_LOADER__(row) {
      if (!this.validateNewRow(row)) {
        // validation fail
        return;
      }
      var msg = this.props.onEditRow(row);
      if (msg !== false) {
        this.afterHandleSaveBtnClick(msg);
      }
    }
    ...
    value: function render() {
      ...
      if (this.props.enableInsert) {
        if (this.props.insertBtn) {
          insertBtn = this.renderCustomBtn(this.props.insertBtn, [this.handleInsertModalOpen], _InsertButton2.default.name, 'onClick', this.handleInsertModalClose);
        } else {
          insertBtn = _react2.default.createElement(_InsertButton2.default, { btnText: this.props.insertText,
            onClick: this.handleInsertModalOpen });
        }
      }
      ...
      if (this.props.enableEdit) {
        if (this.props.editBtn) {
          editBtn = this.renderCustomBtn(this.props.editBtn, [this.handleEditModalOpen], _EditButton2.default.name, 'onClick', this.handleEditModalClose);
        } else {
          if (this.props.editState.value == 'active') {
            editBtn = _react2.default.createElement(_EditButton2.default, { btnText: this.props.editText,
              onClick: this.handleEditModalOpen });
          } else {
            editBtn = _react2.default.createElement(_EditButton2.default, { btnText: this.props.editText });
          }
          editBtn.props.btnstate.value = this.props.editState.value;
        }
      }
      ...
      var insertModal = this.props.enableInsert ? this.renderInsertRowModal() : null;
      var editModal = this.props.enableEdit ? this.renderEditRowModal() : null;
      ...
      if (this.props.toolBar) {
        toolbar = this.props.toolBar({
          ...
          event: {
            openInsertModal: this.handleInsertModalOpen,
            closeInsertModal: this.handleInsertModalClose,
            openEditModal: this.handleEditModalOpen,
            closeEditModal: this.handleEditModalClose,
    ...
    value: function renderInsertRowModal() {
      ...
      var modal = void 0;
      modal = insertModal && insertModal(this.handleInsertModalClose, this.handleSaveBtnClick, columns, validateState, ignoreEditable);
      ...
      if (!modal) {
        modal = _react2.default.createElement(_InsertModal2.default, {
          ...
          onModalClose: this.handleInsertModalClose,
      ...
      return _react2.default.createElement(
        ...
        { className: 'react-bs-insert-modal modal-dialog',
          ...
          ariaHideApp: false,
          onRequestClose: this.handleInsertModalClose,
          contentLabel: 'Modal' },
        modal
      );
    }
  }, {
    key: 'renderEditRowModal',
    value: function renderEditRowModal() {
      var validateState = this.state.validateState || {};
      var _props = this.props,
          version = _props.version,
          columns = _props.columns,
          data = _props.data.value,
          ignoreEditable = _props.ignoreEditable,
          editModalHeader = _props.editModalHeader,
          editModalBody = _props.editModalBody,
          editModalFooter = _props.editModalFooter,
          editModal = _props.editModal;
      
      var modal = void 0;
      modal = editModal && editModal(this.handleEditModalClose, this.handleEditSaveBtnClick, columns, data, validateState, ignoreEditable);

      if (!modal) {
        modal = _react2.default.createElement(_EditModal2.default, {
          version: version,
          columns: columns,
          data: data,
          validateState: validateState,
          ...
          onSave: this.handleEditSaveBtnClick,
          headerComponent: editModalHeader,
          bodyComponent: editModalBody,
          footerComponent: editModalFooter });
      }
      
      return _react2.default.createElement(
        _reactModal2.default,
        { className: 'react-bs-edit-modal modal-dialog',
          isOpen: this.state.isModalOpen,
          ariaHideApp: false,
...
ToolBar.propTypes = {
  ...
  enableEdit: _propTypes2.default.bool,
  ...
  editModalHeader: _propTypes2.default.func,
  editModalBody: _propTypes2.default.func,
  editModalFooter: _propTypes2.default.func,
  editModal: _propTypes2.default.func,
  insertBtn: _propTypes2.default.func,
  deleteBtn: _propTypes2.default.func,
  editBtn: _propTypes2.default.func,
  editState: _propTypes2.default.object,
...
ToolBar.defaultProps = {
  ...
  editText: _Const2.default.EDIT_BTN_TEXT,
  editState: {
    value: _Const2.default.EDIT_BTN_STATE,
    writable: true
  },
  data: {
    value: {},
