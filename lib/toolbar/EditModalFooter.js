...
var EditModalFooter = function (_Component) {
  _inherits(EditModalFooter, _Component);
  ...
  function EditModalFooter() {
    ...
    _classCallCheck(this, EditModalFooter);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = EditModalFooter.__proto__ || Object.getPrototypeOf(EditModalFooter)).call.apply(_ref, [this].concat(args))), _this), _this.handleCloseBtnClick = function () {
      var _this2;
...
var _temp2 = function () {
  ...
  __REACT_HOT_LOADER__.register(EditModalFooter, 'EditModalFooter', '/Users/allen/Node/react-bootstrap-table-new/react-bootstrap-table/src/toolbar/EditModalFooter.js');

  __REACT_HOT_LOADER__.register(_default, 'default', '/Users/allen/Node/react-bootstrap-table-new/react-bootstrap-table/src/toolbar/EditModalFooter.js');
}();
