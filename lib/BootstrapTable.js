...
var BootstrapTable = function (_Component) {
  ...
  function BootstrapTable(props) {
    ...
    _this.handleEditRow = function () {
      return _this.__handleEditRow__REACT_HOT_LOADER__.apply(_this, arguments);
    };
  ...
  _createClass(BootstrapTable, [{
    ...
    key: '__handleEditROW__REACT_HOT_LOADER__',
    value: function __handleEditRow__REACT_HOT_LOADER__() {
      return this.__handleEditRow__REACT_HOT_LOADER__.apply(this, arguments);
    }
  }, {
    ...
    value: function __handleSelectAllRow__REACT_HOT_LOADER__(e) {
      ...
      if (typeof result == 'undefined' || result !== false) {
        ...
        this.toolbar.setEditBtnState('disabled');
        this.setState(function () {
    ...
    value: function __handleSelectRow__REACT_HOT_LOADER__(row, isSelected, e, rowIndex) {
      ...
      if (typeof result === 'undefined' || result !== false) {
        ...
        var keyfield = this.store.keyField;
        if (currSelected.length == 1) {
          var sendData = this.store.data.find( function ( row ) {
            return row[keyfield] == currSelected;
          });

          this.toolbar.setEditBtnState('active');
          this.toolbar.setSelectedRowData(sendData);
        } else {
          this.toolbar.setEditBtnState('disabled');
        }
        this.setState(function () {
    ...
    key: '__handleEditRow__REACT_HOT_LOADER__',
    value: function __handleEditRow__REACT_HOT_LOADER__(newObj) {
      var _this9 = this;
      
      var isAsync = false;
      var onEditRow = this.props.options.onEditRow;


      var afterHandleEditRow = function afterHandleEditRow(errMsg) {
        if (isAsync) {
          _this9.toolbar.afterHandleSaveBtnClick(errMsg);
        } else {
          return errMsg;
      ...
      var afterEditRowCB = function afterEditRowCB(errMsg) {
        if (typeof errMsg !== 'undefined' && errMsg !== '') return afterHandleEditRow(errMsg);
        if (_this9.allowRemote(_Const2.default.REMOTE_EDIT_ROW)) {
          if (_this9.props.options.afterEditRow) {
            _this9.props.options.afterEditRow(newObj);
          }
          return afterHandleEditRow();
        }

        try {
          var keyfield = _this9.store.keyField;
          for (var i = 0; i < _this9.store.data.length; i++) {
            if (_this9.store.data[i][keyfield] == _this9.store.selected) {
              _this9.store.data[i] = newObj
            }
          }
          _this9.toolbar.setEditBtnState('disabled');
          _this9.store.setSelectedRowKey([]);
        } catch (e) {
          return afterHandleEditRow(e.message);
        }
        _this9._handleAfterEditingRow(newObj, false);
        return afterHandleEditRow();
      };

      if (onEditRow) {
        var colInfos = this.store.getColInfos();
        var errMsg = onEditRow(newObj, colInfos, afterEditRowCB);

        if (errMsg !== '' && errMsg !== false) {
          return errMsg;
        } else if (typeof errMsg === 'undefined') {
          return afterEditRowCB();
        } else {
          isAsync = true;
          return !isAsync;
        }
    ...
    value: function renderToolBar() {
      ...
      if (enableShowOnlySelected || insertRow || deleteRow || editRow || search || exportCSV || this.props.options.searchPanel || this.props.options.btnGroup || this.props.options.toolBar) {
        var columns = void 0;
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(_ToolBar2.default, {
            ...
            editText: this.props.options.editText,
            ...
            editModalHeader: this.props.options.editModalHeader,
            editModalFooter: this.props.options.editModalFooter,
            editModalBody: this.props.options.editModalBody,
            editModal: this.props.options.editModal,
            insertBtn: this.props.options.insertBtn,
            deleteBtn: this.props.options.deleteBtn,
            editBtn: this.props.options.editBtn,
    ...
    key: '_handleAfterEditingRow',
    value: function _handleAfterEditingRow(newObj, atTheBeginning) {
      var result = void 0;
      if (this.props.pagination) {
        // if pagination is enabled and inserting row at the end,
        // change page to the last page
...
BootstrapTable.propTypes = {
  ...
  editRow: _propTypes2.default.bool,
  ...
  options: _propTypes2.default.shape({
    ...
    afterEditRow: _propTypes2.default.func,
    ...
    onEditRow: _propTypes2.default.func,
